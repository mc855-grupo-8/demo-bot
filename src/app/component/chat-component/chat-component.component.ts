...
export class ChatComponentComponent {
  ...
  messageList: any = {
    introduction: {
      ...this.model,
      text:
        'Seja bem-vindo ao Ambulatório da pediatria, poderia informar sobre você?\n\n' +
    ...
    wait: {
      ...this.model,
      text: 'Por favor, reserve seu HC, que é o número dado pela recepção e em breve você será atendido/a.',
      options: ['finish'],
    },
    'im-taking-pacient': {
      ...this.model,
